...
# --- kana -> Hepburn romaji ---------------------------------------------------
# Mirror of `_kata_to_hira` / `_ROMAJI` / `_kana_to_romaji` in app.py. Duplicated
# rather than imported because app.py loads Flask + parquet at import time; the
# project already duplicates such constants across build scripts. Keep in sync.
